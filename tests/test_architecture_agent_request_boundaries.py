...
_PRODUCT_REQUEST_ALLOWED_DIRECT_IMPORTS = frozenset(
    {
        ...
        "pipy_harness.native.extension_hooks.dispatch_before_provider_request_hooks",
        "pipy_harness.native.extension_types",
        "pipy_harness.native.extension_types.ExtensionModelRuntimeControl",
        "pipy_harness.native.extension_types.ExtensionUiDriver",
        "pipy_harness.native.extension_types.ProviderRequestTransform",
        "pipy_harness.native.extensions.contracts",
        "pipy_harness.native.extensions.contracts.HookHandler",
        "pipy_harness.native.tools.base",
        "pipy_harness.native.tools.base.ToolDefinition",
        "typing",
...
_PRODUCT_FORBIDDEN_PREFIXES = (
    ...
    "pipy_harness.native.providers.google_vertex",
