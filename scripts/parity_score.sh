#!/usr/bin/env bash
# Reproducible 49-row parity-score check against docs/parity-criterion.md.
...
check A7  "google-vertex"            small  "test -f src/pipy_harness/native/providers/google_vertex.py"
