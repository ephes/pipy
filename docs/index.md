...
6. [Sessions](sessions.md) and [Compaction](compaction.md): native product
...
15. [Session Storage](session-storage.md): the metadata-only catalog utility.
...
16. [Backlog](backlog.md): current product planning, completed slices,
