...
cut 2 and the anthropic/bedrock wire helpers consolidated in cut 3; Gemini/Vertex
remain top-level until their own sub-slice.
...
message is redacted). The anthropic/bedrock wire helpers stay unconsolidated
(that is cut 3); Gemini/Vertex remain top-level until their own sub-slice.
