...
default-token change is introduced. Anthropic, Bedrock, and Codex are untouched
(they keep their own SSE/signed transports and land with the protocol-family
migrations in Slice 5.2).
