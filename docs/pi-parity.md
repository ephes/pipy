...
- Extension/package parity beyond the landed Python core: installed local-path
  ...
  themes at lowest precedence with `+/-pattern` filters. Pi-level rich TUI
  extension UI, custom message/tool rendering, session/tree/compaction
