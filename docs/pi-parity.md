...
**Current delta note (2026-07-16):** local Pi main `b084d2fb` (`0.80.6` plus
...
Durable extension entry renderers, cache-friendly dynamic tool loading, and
