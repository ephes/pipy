...
- Extension/package parity beyond the landed Python core: installed local-path
  ...
  invalidation (beyond the landed render-once snapshot),
  broader dynamic extension flag integration, extension state/session-manager
  helpers, PyPI/npm package sources, and OAuth-provider extension registration
  remain future work.
