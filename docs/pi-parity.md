...
`grep`, `ls`, and `edit-diff`, plus internal output-bounding helpers; the table
compares the default product posture rather than every shipped helper.
