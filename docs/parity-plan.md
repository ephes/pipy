...
1. **Extension / package platform follow-ons**
   ...
   (extension-editor external-editor handoff, a custom editor component —
   item D, autocomplete providers, live per-frame component
