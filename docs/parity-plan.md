...
1. **Extension / package platform follow-ons**
   ...
   custom editor component, live per-frame chrome animation, multi-widget message
   components — persistent chrome widgets now ship), broader dynamic-flag
