...
1. **Extension / package platform follow-ons**
   ...
   (broader custom editor component-library parity beyond the landed component
   store, multi-widget message components
