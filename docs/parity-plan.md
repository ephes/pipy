...
1. **Extension / package platform follow-ons**
   ...
   integration, multi-widget message components plus deferred message-entry
...
3. **Provider / model catalog follow-ons** ([provider-catalog.md](provider-catalog.md))
   ...
   settings-derived retry policy, and broader local-provider maturity. Vertex
