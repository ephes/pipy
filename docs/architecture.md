...
- `pipy-session` can initialize, append, finalize, list, search, inspect,
  export, report metadata-only resume context, and verify finalized records.
